...
class Component extends React.Component {
  ...
  submitOrder = (event, gifts, total) => {
    ...
    else if (!gifts.length) error = 'Your shoping basket is empty';
    ...
    if (!error) {
      ...
      const productsData = gifts.map(gift => (
        {
          _id: gift._id,
          amount: gift.amount,
          notes: gift.notes,
  ...
  render() {
    ...
    return (
      <div className={styles.root}>
        <form noValidate onSubmit={e => submitOrder(e, cart.gifts, total)}>
